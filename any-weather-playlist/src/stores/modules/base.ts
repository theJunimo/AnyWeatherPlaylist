...
export const getWeatherSuccess = (data: {main: string, temp: number}) =>({type: GET_WEATHER_SUCCESS, payload: data}) ;
export const getWeatherError = () => ({type: GET_WEATHER_ERROR});

//action객체에 대한 ts type
type ActionType = | ReturnType<typeof saveUserName> | ReturnType<typeof errorOccurred> | ReturnType<typeof getWeatherSuccess>
| ReturnType<typeof getWeatherLoading> | ReturnType<typeof getWeatherError> 
